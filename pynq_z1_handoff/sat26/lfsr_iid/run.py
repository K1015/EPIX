"""Run the sat26 26-variable solver with one shared LFSR on PYNQ-Z1."""
import argparse
import hashlib
import json
import os
...
def load():
    ...
    require(io.read(0) == 0x53413236 and io.read(4) == 0x30000, 'Wrong shared-LFSR hardware identity')
...
def main():
    ...
    cfg, problem = check()
    if args.check:
        print('PASS: deployment files and fixed sat26 problem verified')
        return
