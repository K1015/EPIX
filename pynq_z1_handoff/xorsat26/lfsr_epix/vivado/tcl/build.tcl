...
set_property display_name {xorsat26 shared LFSR solver} $core
set_property description {xorsat26 fixed 26-variable solver, one shared serial LFSR, runtime IID/EPIX mode, ABI 3.0.} $core
...
file mkdir $deliver
file copy [file join $work project ${project_name}.runs impl_1 design_1_wrapper.bit] [file join $deliver xorsat26_shared_lfsr_100mhz.bit]
set hwh [file join $work project ${project_name}.gen sources_1 bd design_1 hw_handoff design_1.hwh]
if {![file exists $hwh]} { error "Missing hardware handoff: $hwh" }
file copy $hwh [file join $deliver xorsat26_shared_lfsr_100mhz.hwh]
