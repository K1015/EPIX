...
module maxcut26_axi (
    ...
    maxcut26_core solver (
        ...
        .trace_valid(), .trace_take_fresh(), .trace_age_after(), .trace_visit(), .trace_word(), .trace_best_visit(),
        .trace_node(), .trace_sweep(), .trace_field(), .trace_q()
    );
    integer lane;
    reg write_error;
        ...
        if (!s_axi_aresetn) begin
            ...
            if (s_axi_arready && s_axi_arvalid) begin
                ...
                case (s_axi_araddr)
                    ...
                    12'h004: s_axi_rdata <= 32'h00020001; // ABI 2.1: shared LFSR, 100 MHz
                    ...
                    12'h050: s_axi_rdata <= 32'd285;
                    12'h054: s_axi_rdata <= -32'sd172;
                    12'h058: s_axi_rdata <= 32'd398;
