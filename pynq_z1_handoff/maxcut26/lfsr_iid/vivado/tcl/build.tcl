...
# The Python helper selects bundled projects by default; --from-rtl recreates them.
...
set_property display_name {MaxCut 26 p-bit one shared LFSR and EPIX solver} $core
set_property description {Fixed 26-node MaxCut, sequential heat bath, one shared serial LFSRs, runtime Fresh/EPIX mode, ABI 2.1.} $core
...
file mkdir $deliver
file copy [file join $work project ${project_name}.runs impl_1 design_1_wrapper.bit] [file join $deliver maxcut26_shared_lfsr_100mhz.bit]
set hwh [file join $work project ${project_name}.gen sources_1 bd design_1 hw_handoff design_1.hwh]
if {![file exists $hwh]} { error "Missing hardware handoff: $hwh" }
file copy $hwh [file join $deliver maxcut26_shared_lfsr_100mhz.hwh]
set receipt [open [file join $deliver BUILD.txt] w]
puts $receipt "Vivado [version -short]\nPart $part\nClock 100 MHz\nMode IID-fresh/EPIX, one shared LFSR, ABI 2.1, delta_q 1, age_max 2\nSetup slack $setup_slack ns\nHold slack $hold_slack ns\nSource $root\nAXI base 0x43C00000"
close $receipt
