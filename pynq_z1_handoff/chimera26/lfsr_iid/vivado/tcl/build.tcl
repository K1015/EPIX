...
set_property display_name {chimera26 shared LFSR solver} $core
set_property description {chimera26 fixed 26-variable solver, one shared serial LFSR, runtime IID/EPIX mode, ABI 3.0.} $core
...
file mkdir $deliver
file copy [file join $work project ${project_name}.runs impl_1 design_1_wrapper.bit] [file join $deliver chimera26_shared_lfsr_100mhz.bit]
set hwh [file join $work project ${project_name}.gen sources_1 bd design_1 hw_handoff design_1.hwh]
if {![file exists $hwh]} { error "Missing hardware handoff: $hwh" }
file copy $hwh [file join $deliver chimera26_shared_lfsr_100mhz.hwh]
set receipt [open [file join $deliver BUILD.txt] w]
puts $receipt "Vivado [version -short]\nPart $part\nClock 100 MHz\nMode IID/EPIX, one shared LFSR, ABI 3.0\nSetup slack $setup_slack ns\nHold slack $hold_slack ns\nSource $root\nAXI base 0x43C00000"
close $receipt
