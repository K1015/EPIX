...
# PS7 property list extracted from the official PYNQ-Z1 base overlay.
# Source: Xilinx/PYNQ v3.0.1, commit 93ddd21ab623883590a8c8b07f0b157b2855da4b.
# Source design generated by Vivado 2022.1; this project targets 2022.2.
# DDR and MIO configuration is retained. PL ports and clock overrides follow.
proc configure_pynq_z1_ps7 {ps} {
    ...
    # The overlay only exposes GP0, one fabric clock/reset, DDR and FIXED_IO.
    foreach {key value} {
        PCW_USE_M_AXI_GP0 1 PCW_USE_M_AXI_GP1 0
        PCW_USE_S_AXI_GP0 0 PCW_USE_S_AXI_GP1 0
        PCW_USE_S_AXI_HP0 0 PCW_USE_S_AXI_HP1 0
        PCW_USE_S_AXI_HP2 0 PCW_USE_S_AXI_HP3 0
        PCW_USE_S_AXI_ACP 0 PCW_USE_FABRIC_INTERRUPT 0
        PCW_EN_CLK0_PORT 1 PCW_EN_CLK1_PORT 0
        PCW_EN_CLK2_PORT 0 PCW_EN_CLK3_PORT 0
        PCW_FPGA_FCLK0_ENABLE 1 PCW_FPGA_FCLK1_ENABLE 0
        PCW_FPGA_FCLK2_ENABLE 0 PCW_FPGA_FCLK3_ENABLE 0
        PCW_EN_RST0_PORT 1 PCW_EN_RST1_PORT 0
        PCW_EN_RST2_PORT 0 PCW_EN_RST3_PORT 0
        PCW_FPGA0_PERIPHERAL_FREQMHZ 100.000000
        PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ 100.000000
        PCW_FCLK0_PERIPHERAL_DIVISOR0 5 PCW_FCLK0_PERIPHERAL_DIVISOR1 2
        PCW_EN_EMIO_GPIO 0 PCW_GPIO_EMIO_GPIO_ENABLE 0
        PCW_EN_EMIO_I2C0 0 PCW_I2C0_PERIPHERAL_ENABLE 0
    } { dict set configuration CONFIG.$key $value }
    set_property -dict $configuration $ps
}
