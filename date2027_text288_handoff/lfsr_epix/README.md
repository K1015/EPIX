...
This folder defaults to EPIX. Use `--mode paired --trials 100` for the full paired experiment. Each trial performs 1024 full sweeps. Results use a new `runs/` directory. Copy this whole folder so BIT/HWH/Tcl, config and problem hashes stay matched.
