# kings_maxcut800_instance1: EPIX
...
```bash
./run.sh simulate --cases kings_maxcut800_instance1 --mode epix
```
...
Use `-f cases/kings_maxcut800_instance1/epix/files.f` from the package root. Build one case and mode at a time.
