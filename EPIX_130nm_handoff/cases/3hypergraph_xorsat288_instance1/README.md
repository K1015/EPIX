# 3hypergraph_xorsat288_instance1

3-XOR-SAT with 288 variables; 193 factors; target 0 weighted violations.

Run both modes from the [package root](../../README.md):

```bash
./run.sh simulate --cases 3hypergraph_xorsat288_instance1
```
...
| [coefficients.hex](coefficients.hex) | 1,060 packed 32-bit words for factors and adjacency. |
...
- 1,060 × 32-bit coefficient memory; 9 SRAM22 banks share one logical port.
