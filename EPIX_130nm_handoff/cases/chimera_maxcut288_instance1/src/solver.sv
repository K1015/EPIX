...
`define EPIX_MODE 1
`endif
// 288-bit colored Gibbs solver: search control, decisions, and scores.
...
wire [287:0] current=state_bits,dirty_current=dirty_bits;
...
wire [287:0] state_bits,dirty_bits;
