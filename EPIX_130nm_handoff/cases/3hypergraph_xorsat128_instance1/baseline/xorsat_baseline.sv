module xorsat_baseline_solver #(
    parameter integer N=128, M=86, FAMILY_XOR=1,
    parameter integer NODE_W=7, MEM_WORDS=472,
    parameter integer MEM_AW=9, MEM_W=32, WEIGHT_W=1,
    parameter integer FIELD_W=8, TOTAL_WEIGHT=86, FIELD_BOUND=3,
