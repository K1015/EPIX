# 3hypergraph_xorsat128_instance1: IID baseline
...
```bash
./run.sh simulate --cases 3hypergraph_xorsat128_instance1 --mode baseline
```
...
Use `-f cases/3hypergraph_xorsat128_instance1/baseline/files.f` from the package root. Build one case and mode at a time.
