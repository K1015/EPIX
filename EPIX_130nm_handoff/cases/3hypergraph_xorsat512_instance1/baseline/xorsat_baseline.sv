module xorsat_baseline_solver #(
    parameter integer N=512, M=342, FAMILY_XOR=1,
    parameter integer NODE_W=9, MEM_WORDS=1880,
    parameter integer MEM_AW=11, MEM_W=32, WEIGHT_W=1,
    parameter integer FIELD_W=8, TOTAL_WEIGHT=342, FIELD_BOUND=3,
