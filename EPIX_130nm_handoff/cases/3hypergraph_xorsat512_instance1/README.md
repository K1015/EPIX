# 3hypergraph_xorsat512_instance1

3-XOR-SAT with 512 variables; 342 factors; target 0 weighted violations.

Run both modes from the [package root](../../README.md):

```bash
./run.sh simulate --cases 3hypergraph_xorsat512_instance1
```
...
| [coefficients.hex](coefficients.hex) | 1,880 packed 32-bit words for factors and adjacency. |
...
- 1,880 × 32-bit coefficient memory; 15 SRAM22 banks share one logical port.
