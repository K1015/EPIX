module sat_baseline_solver #(
    parameter integer N=288, M=1238, FAMILY_XOR=0,
    parameter integer NODE_W=9, MEM_WORDS=5240,
    parameter integer MEM_AW=13, MEM_W=32, WEIGHT_W=1,
    parameter integer FIELD_W=8, TOTAL_WEIGHT=1238, FIELD_BOUND=24,
