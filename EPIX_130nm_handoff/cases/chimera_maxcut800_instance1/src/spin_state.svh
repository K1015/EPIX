...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[132];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[133];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[134];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[135];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[136];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[137];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[138];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[139];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[292];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[293];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[294];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[295];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[296];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[297];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[298];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[299];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[308];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[309];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[310];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[311];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[312];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[313];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[314];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[315];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[320];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[321];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[322];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[323];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[332];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[333];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[334];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[335];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[336];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[337];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[338];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[339];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[348];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[349];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[350];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[351];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[352];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[353];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[354];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[355];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[364];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[365];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[366];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[367];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[368];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[369];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[370];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[371];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[380];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[381];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[382];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[383];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[404];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[405];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[406];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[407];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[408];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[409];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[410];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[411];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[420];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[421];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[422];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[423];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[424];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[425];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[426];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[427];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[436];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[437];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[438];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[439];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[440];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[441];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[442];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[443];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[480];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[481];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[482];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[483];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[492];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[493];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[494];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[495];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[496];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[497];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[498];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[499];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[508];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[509];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[510];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[511];invalid<=0;end
 end
end
end
if(1) begin:state_0_512
reg spin,invalid;
assign state_bits[512]=spin;
assign dirty_bits[512]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[512];invalid<=0;end
 end
end
end
if(1) begin:state_0_513
reg spin,invalid;
assign state_bits[513]=spin;
assign dirty_bits[513]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[513];invalid<=0;end
 end
end
end
if(1) begin:state_0_514
reg spin,invalid;
assign state_bits[514]=spin;
assign dirty_bits[514]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[514];invalid<=0;end
 end
end
end
if(1) begin:state_0_515
reg spin,invalid;
assign state_bits[515]=spin;
assign dirty_bits[515]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[515];invalid<=0;end
 end
end
end
if(1) begin:state_0_524
reg spin,invalid;
assign state_bits[524]=spin;
assign dirty_bits[524]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[524];invalid<=0;end
 end
end
end
if(1) begin:state_0_525
reg spin,invalid;
assign state_bits[525]=spin;
assign dirty_bits[525]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[525];invalid<=0;end
 end
end
end
if(1) begin:state_0_526
reg spin,invalid;
assign state_bits[526]=spin;
assign dirty_bits[526]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[526];invalid<=0;end
 end
end
end
if(1) begin:state_0_527
reg spin,invalid;
assign state_bits[527]=spin;
assign dirty_bits[527]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[527];invalid<=0;end
 end
end
end
if(1) begin:state_0_528
reg spin,invalid;
assign state_bits[528]=spin;
assign dirty_bits[528]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[528];invalid<=0;end
 end
end
end
if(1) begin:state_0_529
reg spin,invalid;
assign state_bits[529]=spin;
assign dirty_bits[529]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[529];invalid<=0;end
 end
end
end
if(1) begin:state_0_530
reg spin,invalid;
assign state_bits[530]=spin;
assign dirty_bits[530]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[530];invalid<=0;end
 end
end
end
if(1) begin:state_0_531
reg spin,invalid;
assign state_bits[531]=spin;
assign dirty_bits[531]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[531];invalid<=0;end
 end
end
end
if(1) begin:state_0_540
reg spin,invalid;
assign state_bits[540]=spin;
assign dirty_bits[540]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[540];invalid<=0;end
 end
end
end
if(1) begin:state_0_541
reg spin,invalid;
assign state_bits[541]=spin;
assign dirty_bits[541]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[541];invalid<=0;end
 end
end
end
if(1) begin:state_0_542
reg spin,invalid;
assign state_bits[542]=spin;
assign dirty_bits[542]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[542];invalid<=0;end
 end
end
end
if(1) begin:state_0_543
reg spin,invalid;
assign state_bits[543]=spin;
assign dirty_bits[543]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[543];invalid<=0;end
 end
end
end
if(1) begin:state_0_544
reg spin,invalid;
assign state_bits[544]=spin;
assign dirty_bits[544]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[544];invalid<=0;end
 end
end
end
if(1) begin:state_0_545
reg spin,invalid;
assign state_bits[545]=spin;
assign dirty_bits[545]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[545];invalid<=0;end
 end
end
end
if(1) begin:state_0_546
reg spin,invalid;
assign state_bits[546]=spin;
assign dirty_bits[546]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[546];invalid<=0;end
 end
end
end
if(1) begin:state_0_547
reg spin,invalid;
assign state_bits[547]=spin;
assign dirty_bits[547]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[547];invalid<=0;end
 end
end
end
if(1) begin:state_0_556
reg spin,invalid;
assign state_bits[556]=spin;
assign dirty_bits[556]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[556];invalid<=0;end
 end
end
end
if(1) begin:state_0_557
reg spin,invalid;
assign state_bits[557]=spin;
assign dirty_bits[557]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[557];invalid<=0;end
 end
end
end
if(1) begin:state_0_558
reg spin,invalid;
assign state_bits[558]=spin;
assign dirty_bits[558]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[558];invalid<=0;end
 end
end
end
if(1) begin:state_0_559
reg spin,invalid;
assign state_bits[559]=spin;
assign dirty_bits[559]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[559];invalid<=0;end
 end
end
end
if(1) begin:state_0_564
reg spin,invalid;
assign state_bits[564]=spin;
assign dirty_bits[564]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[564];invalid<=0;end
 end
end
end
if(1) begin:state_0_565
reg spin,invalid;
assign state_bits[565]=spin;
assign dirty_bits[565]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[565];invalid<=0;end
 end
end
end
if(1) begin:state_0_566
reg spin,invalid;
assign state_bits[566]=spin;
assign dirty_bits[566]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[566];invalid<=0;end
 end
end
end
if(1) begin:state_0_567
reg spin,invalid;
assign state_bits[567]=spin;
assign dirty_bits[567]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[567];invalid<=0;end
 end
end
end
if(1) begin:state_0_568
reg spin,invalid;
assign state_bits[568]=spin;
assign dirty_bits[568]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[568];invalid<=0;end
 end
end
end
if(1) begin:state_0_569
reg spin,invalid;
assign state_bits[569]=spin;
assign dirty_bits[569]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[569];invalid<=0;end
 end
end
end
if(1) begin:state_0_570
reg spin,invalid;
assign state_bits[570]=spin;
assign dirty_bits[570]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[570];invalid<=0;end
 end
end
end
if(1) begin:state_0_571
reg spin,invalid;
assign state_bits[571]=spin;
assign dirty_bits[571]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[571];invalid<=0;end
 end
end
end
if(1) begin:state_0_580
reg spin,invalid;
assign state_bits[580]=spin;
assign dirty_bits[580]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[580];invalid<=0;end
 end
end
end
if(1) begin:state_0_581
reg spin,invalid;
assign state_bits[581]=spin;
assign dirty_bits[581]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[581];invalid<=0;end
 end
end
end
if(1) begin:state_0_582
reg spin,invalid;
assign state_bits[582]=spin;
assign dirty_bits[582]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[582];invalid<=0;end
 end
end
end
if(1) begin:state_0_583
reg spin,invalid;
assign state_bits[583]=spin;
assign dirty_bits[583]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[583];invalid<=0;end
 end
end
end
if(1) begin:state_0_584
reg spin,invalid;
assign state_bits[584]=spin;
assign dirty_bits[584]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[584];invalid<=0;end
 end
end
end
if(1) begin:state_0_585
reg spin,invalid;
assign state_bits[585]=spin;
assign dirty_bits[585]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[585];invalid<=0;end
 end
end
end
if(1) begin:state_0_586
reg spin,invalid;
assign state_bits[586]=spin;
assign dirty_bits[586]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[586];invalid<=0;end
 end
end
end
if(1) begin:state_0_587
reg spin,invalid;
assign state_bits[587]=spin;
assign dirty_bits[587]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[587];invalid<=0;end
 end
end
end
if(1) begin:state_0_596
reg spin,invalid;
assign state_bits[596]=spin;
assign dirty_bits[596]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[596];invalid<=0;end
 end
end
end
if(1) begin:state_0_597
reg spin,invalid;
assign state_bits[597]=spin;
assign dirty_bits[597]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[597];invalid<=0;end
 end
end
end
if(1) begin:state_0_598
reg spin,invalid;
assign state_bits[598]=spin;
assign dirty_bits[598]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[598];invalid<=0;end
 end
end
end
if(1) begin:state_0_599
reg spin,invalid;
assign state_bits[599]=spin;
assign dirty_bits[599]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[599];invalid<=0;end
 end
end
end
if(1) begin:state_0_600
reg spin,invalid;
assign state_bits[600]=spin;
assign dirty_bits[600]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[600];invalid<=0;end
 end
end
end
if(1) begin:state_0_601
reg spin,invalid;
assign state_bits[601]=spin;
assign dirty_bits[601]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[601];invalid<=0;end
 end
end
end
if(1) begin:state_0_602
reg spin,invalid;
assign state_bits[602]=spin;
assign dirty_bits[602]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[602];invalid<=0;end
 end
end
end
if(1) begin:state_0_603
reg spin,invalid;
assign state_bits[603]=spin;
assign dirty_bits[603]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[603];invalid<=0;end
 end
end
end
if(1) begin:state_0_612
reg spin,invalid;
assign state_bits[612]=spin;
assign dirty_bits[612]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[612];invalid<=0;end
 end
end
end
if(1) begin:state_0_613
reg spin,invalid;
assign state_bits[613]=spin;
assign dirty_bits[613]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[613];invalid<=0;end
 end
end
end
if(1) begin:state_0_614
reg spin,invalid;
assign state_bits[614]=spin;
assign dirty_bits[614]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[614];invalid<=0;end
 end
end
end
if(1) begin:state_0_615
reg spin,invalid;
assign state_bits[615]=spin;
assign dirty_bits[615]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[615];invalid<=0;end
 end
end
end
if(1) begin:state_0_616
reg spin,invalid;
assign state_bits[616]=spin;
assign dirty_bits[616]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[616];invalid<=0;end
 end
end
end
if(1) begin:state_0_617
reg spin,invalid;
assign state_bits[617]=spin;
assign dirty_bits[617]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[617];invalid<=0;end
 end
end
end
if(1) begin:state_0_618
reg spin,invalid;
assign state_bits[618]=spin;
assign dirty_bits[618]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[618];invalid<=0;end
 end
end
end
if(1) begin:state_0_619
reg spin,invalid;
assign state_bits[619]=spin;
assign dirty_bits[619]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[619];invalid<=0;end
 end
end
end
if(1) begin:state_0_628
reg spin,invalid;
assign state_bits[628]=spin;
assign dirty_bits[628]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[628];invalid<=0;end
 end
end
end
if(1) begin:state_0_629
reg spin,invalid;
assign state_bits[629]=spin;
assign dirty_bits[629]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[629];invalid<=0;end
 end
end
end
if(1) begin:state_0_630
reg spin,invalid;
assign state_bits[630]=spin;
assign dirty_bits[630]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[630];invalid<=0;end
 end
end
end
if(1) begin:state_0_631
reg spin,invalid;
assign state_bits[631]=spin;
assign dirty_bits[631]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[631];invalid<=0;end
 end
end
end
if(1) begin:state_0_632
reg spin,invalid;
assign state_bits[632]=spin;
assign dirty_bits[632]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[632];invalid<=0;end
 end
end
end
if(1) begin:state_0_633
reg spin,invalid;
assign state_bits[633]=spin;
assign dirty_bits[633]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[633];invalid<=0;end
 end
end
end
if(1) begin:state_0_634
reg spin,invalid;
assign state_bits[634]=spin;
assign dirty_bits[634]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[634];invalid<=0;end
 end
end
end
if(1) begin:state_0_635
reg spin,invalid;
assign state_bits[635]=spin;
assign dirty_bits[635]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[635];invalid<=0;end
 end
end
end
if(1) begin:state_0_640
reg spin,invalid;
assign state_bits[640]=spin;
assign dirty_bits[640]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[640];invalid<=0;end
 end
end
end
if(1) begin:state_0_641
reg spin,invalid;
assign state_bits[641]=spin;
assign dirty_bits[641]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[641];invalid<=0;end
 end
end
end
if(1) begin:state_0_642
reg spin,invalid;
assign state_bits[642]=spin;
assign dirty_bits[642]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[642];invalid<=0;end
 end
end
end
if(1) begin:state_0_643
reg spin,invalid;
assign state_bits[643]=spin;
assign dirty_bits[643]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[643];invalid<=0;end
 end
end
end
if(1) begin:state_0_652
reg spin,invalid;
assign state_bits[652]=spin;
assign dirty_bits[652]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[652];invalid<=0;end
 end
end
end
if(1) begin:state_0_653
reg spin,invalid;
assign state_bits[653]=spin;
assign dirty_bits[653]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[653];invalid<=0;end
 end
end
end
if(1) begin:state_0_654
reg spin,invalid;
assign state_bits[654]=spin;
assign dirty_bits[654]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[654];invalid<=0;end
 end
end
end
if(1) begin:state_0_655
reg spin,invalid;
assign state_bits[655]=spin;
assign dirty_bits[655]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[655];invalid<=0;end
 end
end
end
if(1) begin:state_0_656
reg spin,invalid;
assign state_bits[656]=spin;
assign dirty_bits[656]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[656];invalid<=0;end
 end
end
end
if(1) begin:state_0_657
reg spin,invalid;
assign state_bits[657]=spin;
assign dirty_bits[657]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[657];invalid<=0;end
 end
end
end
if(1) begin:state_0_658
reg spin,invalid;
assign state_bits[658]=spin;
assign dirty_bits[658]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[658];invalid<=0;end
 end
end
end
if(1) begin:state_0_659
reg spin,invalid;
assign state_bits[659]=spin;
assign dirty_bits[659]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[659];invalid<=0;end
 end
end
end
if(1) begin:state_0_668
reg spin,invalid;
assign state_bits[668]=spin;
assign dirty_bits[668]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[668];invalid<=0;end
 end
end
end
if(1) begin:state_0_669
reg spin,invalid;
assign state_bits[669]=spin;
assign dirty_bits[669]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[669];invalid<=0;end
 end
end
end
if(1) begin:state_0_670
reg spin,invalid;
assign state_bits[670]=spin;
assign dirty_bits[670]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[670];invalid<=0;end
 end
end
end
if(1) begin:state_0_671
reg spin,invalid;
assign state_bits[671]=spin;
assign dirty_bits[671]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[671];invalid<=0;end
 end
end
end
if(1) begin:state_0_672
reg spin,invalid;
assign state_bits[672]=spin;
assign dirty_bits[672]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[672];invalid<=0;end
 end
end
end
if(1) begin:state_0_673
reg spin,invalid;
assign state_bits[673]=spin;
assign dirty_bits[673]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[673];invalid<=0;end
 end
end
end
if(1) begin:state_0_674
reg spin,invalid;
assign state_bits[674]=spin;
assign dirty_bits[674]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[674];invalid<=0;end
 end
end
end
if(1) begin:state_0_675
reg spin,invalid;
assign state_bits[675]=spin;
assign dirty_bits[675]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[675];invalid<=0;end
 end
end
end
if(1) begin:state_0_684
reg spin,invalid;
assign state_bits[684]=spin;
assign dirty_bits[684]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[684];invalid<=0;end
 end
end
end
if(1) begin:state_0_685
reg spin,invalid;
assign state_bits[685]=spin;
assign dirty_bits[685]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[685];invalid<=0;end
 end
end
end
if(1) begin:state_0_686
reg spin,invalid;
assign state_bits[686]=spin;
assign dirty_bits[686]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[686];invalid<=0;end
 end
end
end
if(1) begin:state_0_687
reg spin,invalid;
assign state_bits[687]=spin;
assign dirty_bits[687]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[687];invalid<=0;end
 end
end
end
if(1) begin:state_0_688
reg spin,invalid;
assign state_bits[688]=spin;
assign dirty_bits[688]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[688];invalid<=0;end
 end
end
end
if(1) begin:state_0_689
reg spin,invalid;
assign state_bits[689]=spin;
assign dirty_bits[689]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[689];invalid<=0;end
 end
end
end
if(1) begin:state_0_690
reg spin,invalid;
assign state_bits[690]=spin;
assign dirty_bits[690]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[690];invalid<=0;end
 end
end
end
if(1) begin:state_0_691
reg spin,invalid;
assign state_bits[691]=spin;
assign dirty_bits[691]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[691];invalid<=0;end
 end
end
end
if(1) begin:state_0_700
reg spin,invalid;
assign state_bits[700]=spin;
assign dirty_bits[700]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[700];invalid<=0;end
 end
end
end
if(1) begin:state_0_701
reg spin,invalid;
assign state_bits[701]=spin;
assign dirty_bits[701]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[701];invalid<=0;end
 end
end
end
if(1) begin:state_0_702
reg spin,invalid;
assign state_bits[702]=spin;
assign dirty_bits[702]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[702];invalid<=0;end
 end
end
end
if(1) begin:state_0_703
reg spin,invalid;
assign state_bits[703]=spin;
assign dirty_bits[703]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[703];invalid<=0;end
 end
end
end
if(1) begin:state_0_704
reg spin,invalid;
assign state_bits[704]=spin;
assign dirty_bits[704]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[704];invalid<=0;end
 end
end
end
if(1) begin:state_0_705
reg spin,invalid;
assign state_bits[705]=spin;
assign dirty_bits[705]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[705];invalid<=0;end
 end
end
end
if(1) begin:state_0_706
reg spin,invalid;
assign state_bits[706]=spin;
assign dirty_bits[706]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[706];invalid<=0;end
 end
end
end
if(1) begin:state_0_707
reg spin,invalid;
assign state_bits[707]=spin;
assign dirty_bits[707]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[707];invalid<=0;end
 end
end
end
if(1) begin:state_0_716
reg spin,invalid;
assign state_bits[716]=spin;
assign dirty_bits[716]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[716];invalid<=0;end
 end
end
end
if(1) begin:state_0_717
reg spin,invalid;
assign state_bits[717]=spin;
assign dirty_bits[717]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[717];invalid<=0;end
 end
end
end
if(1) begin:state_0_718
reg spin,invalid;
assign state_bits[718]=spin;
assign dirty_bits[718]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[718];invalid<=0;end
 end
end
end
if(1) begin:state_0_719
reg spin,invalid;
assign state_bits[719]=spin;
assign dirty_bits[719]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[719];invalid<=0;end
 end
end
end
if(1) begin:state_0_724
reg spin,invalid;
assign state_bits[724]=spin;
assign dirty_bits[724]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[724];invalid<=0;end
 end
end
end
if(1) begin:state_0_725
reg spin,invalid;
assign state_bits[725]=spin;
assign dirty_bits[725]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[725];invalid<=0;end
 end
end
end
if(1) begin:state_0_726
reg spin,invalid;
assign state_bits[726]=spin;
assign dirty_bits[726]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[726];invalid<=0;end
 end
end
end
if(1) begin:state_0_727
reg spin,invalid;
assign state_bits[727]=spin;
assign dirty_bits[727]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[727];invalid<=0;end
 end
end
end
if(1) begin:state_0_728
reg spin,invalid;
assign state_bits[728]=spin;
assign dirty_bits[728]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[728];invalid<=0;end
 end
end
end
if(1) begin:state_0_729
reg spin,invalid;
assign state_bits[729]=spin;
assign dirty_bits[729]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[729];invalid<=0;end
 end
end
end
if(1) begin:state_0_730
reg spin,invalid;
assign state_bits[730]=spin;
assign dirty_bits[730]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[730];invalid<=0;end
 end
end
end
if(1) begin:state_0_731
reg spin,invalid;
assign state_bits[731]=spin;
assign dirty_bits[731]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[731];invalid<=0;end
 end
end
end
if(1) begin:state_0_740
reg spin,invalid;
assign state_bits[740]=spin;
assign dirty_bits[740]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[740];invalid<=0;end
 end
end
end
if(1) begin:state_0_741
reg spin,invalid;
assign state_bits[741]=spin;
assign dirty_bits[741]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[741];invalid<=0;end
 end
end
end
if(1) begin:state_0_742
reg spin,invalid;
assign state_bits[742]=spin;
assign dirty_bits[742]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[742];invalid<=0;end
 end
end
end
if(1) begin:state_0_743
reg spin,invalid;
assign state_bits[743]=spin;
assign dirty_bits[743]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[743];invalid<=0;end
 end
end
end
if(1) begin:state_0_744
reg spin,invalid;
assign state_bits[744]=spin;
assign dirty_bits[744]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[744];invalid<=0;end
 end
end
end
if(1) begin:state_0_745
reg spin,invalid;
assign state_bits[745]=spin;
assign dirty_bits[745]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[745];invalid<=0;end
 end
end
end
if(1) begin:state_0_746
reg spin,invalid;
assign state_bits[746]=spin;
assign dirty_bits[746]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[746];invalid<=0;end
 end
end
end
if(1) begin:state_0_747
reg spin,invalid;
assign state_bits[747]=spin;
assign dirty_bits[747]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[747];invalid<=0;end
 end
end
end
if(1) begin:state_0_756
reg spin,invalid;
assign state_bits[756]=spin;
assign dirty_bits[756]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[756];invalid<=0;end
 end
end
end
if(1) begin:state_0_757
reg spin,invalid;
assign state_bits[757]=spin;
assign dirty_bits[757]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[757];invalid<=0;end
 end
end
end
if(1) begin:state_0_758
reg spin,invalid;
assign state_bits[758]=spin;
assign dirty_bits[758]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[758];invalid<=0;end
 end
end
end
if(1) begin:state_0_759
reg spin,invalid;
assign state_bits[759]=spin;
assign dirty_bits[759]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[759];invalid<=0;end
 end
end
end
if(1) begin:state_0_760
reg spin,invalid;
assign state_bits[760]=spin;
assign dirty_bits[760]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[760];invalid<=0;end
 end
end
end
if(1) begin:state_0_761
reg spin,invalid;
assign state_bits[761]=spin;
assign dirty_bits[761]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[761];invalid<=0;end
 end
end
end
if(1) begin:state_0_762
reg spin,invalid;
assign state_bits[762]=spin;
assign dirty_bits[762]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[762];invalid<=0;end
 end
end
end
if(1) begin:state_0_763
reg spin,invalid;
assign state_bits[763]=spin;
assign dirty_bits[763]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[763];invalid<=0;end
 end
end
end
if(1) begin:state_0_772
reg spin,invalid;
assign state_bits[772]=spin;
assign dirty_bits[772]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[772];invalid<=0;end
 end
end
end
if(1) begin:state_0_773
reg spin,invalid;
assign state_bits[773]=spin;
assign dirty_bits[773]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[773];invalid<=0;end
 end
end
end
if(1) begin:state_0_774
reg spin,invalid;
assign state_bits[774]=spin;
assign dirty_bits[774]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[774];invalid<=0;end
 end
end
end
if(1) begin:state_0_775
reg spin,invalid;
assign state_bits[775]=spin;
assign dirty_bits[775]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[775];invalid<=0;end
 end
end
end
if(1) begin:state_0_776
reg spin,invalid;
assign state_bits[776]=spin;
assign dirty_bits[776]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[776];invalid<=0;end
 end
end
end
if(1) begin:state_0_777
reg spin,invalid;
assign state_bits[777]=spin;
assign dirty_bits[777]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[777];invalid<=0;end
 end
end
end
if(1) begin:state_0_778
reg spin,invalid;
assign state_bits[778]=spin;
assign dirty_bits[778]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[778];invalid<=0;end
 end
end
end
if(1) begin:state_0_779
reg spin,invalid;
assign state_bits[779]=spin;
assign dirty_bits[779]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[779];invalid<=0;end
 end
end
end
if(1) begin:state_0_788
reg spin,invalid;
assign state_bits[788]=spin;
assign dirty_bits[788]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[788];invalid<=0;end
 end
end
end
if(1) begin:state_0_789
reg spin,invalid;
assign state_bits[789]=spin;
assign dirty_bits[789]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[789];invalid<=0;end
 end
end
end
if(1) begin:state_0_790
reg spin,invalid;
assign state_bits[790]=spin;
assign dirty_bits[790]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[790];invalid<=0;end
 end
end
end
if(1) begin:state_0_791
reg spin,invalid;
assign state_bits[791]=spin;
assign dirty_bits[791]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[791];invalid<=0;end
 end
end
end
if(1) begin:state_0_792
reg spin,invalid;
assign state_bits[792]=spin;
assign dirty_bits[792]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[792];invalid<=0;end
 end
end
end
if(1) begin:state_0_793
reg spin,invalid;
assign state_bits[793]=spin;
assign dirty_bits[793]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[793];invalid<=0;end
 end
end
end
if(1) begin:state_0_794
reg spin,invalid;
assign state_bits[794]=spin;
assign dirty_bits[794]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[794];invalid<=0;end
 end
end
end
if(1) begin:state_0_795
reg spin,invalid;
assign state_bits[795]=spin;
assign dirty_bits[795]=invalid;
always @(posedge spin_clk_0_0) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==0)begin spin<=update_bits[795];invalid<=0;end
 end
end
end
wire spin_clk_0_1;
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[128];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[129];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[130];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[131];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[140];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[141];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[142];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[143];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[288];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[289];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[290];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[291];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[300];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[301];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[302];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[303];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[304];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[305];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[306];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[307];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[316];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[317];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[318];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[319];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[324];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[325];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[326];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[327];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[328];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[329];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[330];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[331];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[340];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[341];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[342];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[343];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[344];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[345];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[346];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[347];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[356];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[357];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[358];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[359];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[360];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[361];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[362];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[363];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[372];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[373];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[374];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[375];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[376];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[377];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[378];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[379];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[400];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[401];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[402];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[403];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[412];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[413];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[414];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[415];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[416];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[417];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[418];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[419];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[428];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[429];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[430];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[431];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[432];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[433];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[434];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[435];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[444];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[445];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[446];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[447];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[484];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[485];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[486];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[487];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[488];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[489];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[490];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[491];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[500];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[501];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[502];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[503];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[504];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[505];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[506];invalid<=0;end
 end
end
end
...
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
  ...
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[507];invalid<=0;end
 end
end
end
if(1) begin:state_0_516
reg spin,invalid;
assign state_bits[516]=spin;
assign dirty_bits[516]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[516];invalid<=0;end
 end
end
end
if(1) begin:state_0_517
reg spin,invalid;
assign state_bits[517]=spin;
assign dirty_bits[517]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[517];invalid<=0;end
 end
end
end
if(1) begin:state_0_518
reg spin,invalid;
assign state_bits[518]=spin;
assign dirty_bits[518]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[518];invalid<=0;end
 end
end
end
if(1) begin:state_0_519
reg spin,invalid;
assign state_bits[519]=spin;
assign dirty_bits[519]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[519];invalid<=0;end
 end
end
end
if(1) begin:state_0_520
reg spin,invalid;
assign state_bits[520]=spin;
assign dirty_bits[520]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[520];invalid<=0;end
 end
end
end
if(1) begin:state_0_521
reg spin,invalid;
assign state_bits[521]=spin;
assign dirty_bits[521]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[521];invalid<=0;end
 end
end
end
if(1) begin:state_0_522
reg spin,invalid;
assign state_bits[522]=spin;
assign dirty_bits[522]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[522];invalid<=0;end
 end
end
end
if(1) begin:state_0_523
reg spin,invalid;
assign state_bits[523]=spin;
assign dirty_bits[523]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[523];invalid<=0;end
 end
end
end
if(1) begin:state_0_532
reg spin,invalid;
assign state_bits[532]=spin;
assign dirty_bits[532]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[532];invalid<=0;end
 end
end
end
if(1) begin:state_0_533
reg spin,invalid;
assign state_bits[533]=spin;
assign dirty_bits[533]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[533];invalid<=0;end
 end
end
end
if(1) begin:state_0_534
reg spin,invalid;
assign state_bits[534]=spin;
assign dirty_bits[534]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[534];invalid<=0;end
 end
end
end
if(1) begin:state_0_535
reg spin,invalid;
assign state_bits[535]=spin;
assign dirty_bits[535]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[535];invalid<=0;end
 end
end
end
if(1) begin:state_0_536
reg spin,invalid;
assign state_bits[536]=spin;
assign dirty_bits[536]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[536];invalid<=0;end
 end
end
end
if(1) begin:state_0_537
reg spin,invalid;
assign state_bits[537]=spin;
assign dirty_bits[537]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[537];invalid<=0;end
 end
end
end
if(1) begin:state_0_538
reg spin,invalid;
assign state_bits[538]=spin;
assign dirty_bits[538]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[538];invalid<=0;end
 end
end
end
if(1) begin:state_0_539
reg spin,invalid;
assign state_bits[539]=spin;
assign dirty_bits[539]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==16)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[539];invalid<=0;end
 end
end
end
if(1) begin:state_0_548
reg spin,invalid;
assign state_bits[548]=spin;
assign dirty_bits[548]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[548];invalid<=0;end
 end
end
end
if(1) begin:state_0_549
reg spin,invalid;
assign state_bits[549]=spin;
assign dirty_bits[549]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[549];invalid<=0;end
 end
end
end
if(1) begin:state_0_550
reg spin,invalid;
assign state_bits[550]=spin;
assign dirty_bits[550]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[550];invalid<=0;end
 end
end
end
if(1) begin:state_0_551
reg spin,invalid;
assign state_bits[551]=spin;
assign dirty_bits[551]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[551];invalid<=0;end
 end
end
end
if(1) begin:state_0_552
reg spin,invalid;
assign state_bits[552]=spin;
assign dirty_bits[552]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[552];invalid<=0;end
 end
end
end
if(1) begin:state_0_553
reg spin,invalid;
assign state_bits[553]=spin;
assign dirty_bits[553]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[553];invalid<=0;end
 end
end
end
if(1) begin:state_0_554
reg spin,invalid;
assign state_bits[554]=spin;
assign dirty_bits[554]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[554];invalid<=0;end
 end
end
end
if(1) begin:state_0_555
reg spin,invalid;
assign state_bits[555]=spin;
assign dirty_bits[555]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[555];invalid<=0;end
 end
end
end
if(1) begin:state_0_560
reg spin,invalid;
assign state_bits[560]=spin;
assign dirty_bits[560]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[560];invalid<=0;end
 end
end
end
if(1) begin:state_0_561
reg spin,invalid;
assign state_bits[561]=spin;
assign dirty_bits[561]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[561];invalid<=0;end
 end
end
end
if(1) begin:state_0_562
reg spin,invalid;
assign state_bits[562]=spin;
assign dirty_bits[562]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[562];invalid<=0;end
 end
end
end
if(1) begin:state_0_563
reg spin,invalid;
assign state_bits[563]=spin;
assign dirty_bits[563]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[563];invalid<=0;end
 end
end
end
if(1) begin:state_0_572
reg spin,invalid;
assign state_bits[572]=spin;
assign dirty_bits[572]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[572];invalid<=0;end
 end
end
end
if(1) begin:state_0_573
reg spin,invalid;
assign state_bits[573]=spin;
assign dirty_bits[573]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[573];invalid<=0;end
 end
end
end
if(1) begin:state_0_574
reg spin,invalid;
assign state_bits[574]=spin;
assign dirty_bits[574]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[574];invalid<=0;end
 end
end
end
if(1) begin:state_0_575
reg spin,invalid;
assign state_bits[575]=spin;
assign dirty_bits[575]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==17)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[575];invalid<=0;end
 end
end
end
if(1) begin:state_0_576
reg spin,invalid;
assign state_bits[576]=spin;
assign dirty_bits[576]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[576];invalid<=0;end
 end
end
end
if(1) begin:state_0_577
reg spin,invalid;
assign state_bits[577]=spin;
assign dirty_bits[577]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[577];invalid<=0;end
 end
end
end
if(1) begin:state_0_578
reg spin,invalid;
assign state_bits[578]=spin;
assign dirty_bits[578]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[578];invalid<=0;end
 end
end
end
if(1) begin:state_0_579
reg spin,invalid;
assign state_bits[579]=spin;
assign dirty_bits[579]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[579];invalid<=0;end
 end
end
end
if(1) begin:state_0_588
reg spin,invalid;
assign state_bits[588]=spin;
assign dirty_bits[588]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[588];invalid<=0;end
 end
end
end
if(1) begin:state_0_589
reg spin,invalid;
assign state_bits[589]=spin;
assign dirty_bits[589]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[589];invalid<=0;end
 end
end
end
if(1) begin:state_0_590
reg spin,invalid;
assign state_bits[590]=spin;
assign dirty_bits[590]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[590];invalid<=0;end
 end
end
end
if(1) begin:state_0_591
reg spin,invalid;
assign state_bits[591]=spin;
assign dirty_bits[591]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[591];invalid<=0;end
 end
end
end
if(1) begin:state_0_592
reg spin,invalid;
assign state_bits[592]=spin;
assign dirty_bits[592]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[592];invalid<=0;end
 end
end
end
if(1) begin:state_0_593
reg spin,invalid;
assign state_bits[593]=spin;
assign dirty_bits[593]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[593];invalid<=0;end
 end
end
end
if(1) begin:state_0_594
reg spin,invalid;
assign state_bits[594]=spin;
assign dirty_bits[594]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[594];invalid<=0;end
 end
end
end
if(1) begin:state_0_595
reg spin,invalid;
assign state_bits[595]=spin;
assign dirty_bits[595]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[595];invalid<=0;end
 end
end
end
if(1) begin:state_0_604
reg spin,invalid;
assign state_bits[604]=spin;
assign dirty_bits[604]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[604];invalid<=0;end
 end
end
end
if(1) begin:state_0_605
reg spin,invalid;
assign state_bits[605]=spin;
assign dirty_bits[605]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[605];invalid<=0;end
 end
end
end
if(1) begin:state_0_606
reg spin,invalid;
assign state_bits[606]=spin;
assign dirty_bits[606]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[606];invalid<=0;end
 end
end
end
if(1) begin:state_0_607
reg spin,invalid;
assign state_bits[607]=spin;
assign dirty_bits[607]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==18)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[607];invalid<=0;end
 end
end
end
if(1) begin:state_0_608
reg spin,invalid;
assign state_bits[608]=spin;
assign dirty_bits[608]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[608];invalid<=0;end
 end
end
end
if(1) begin:state_0_609
reg spin,invalid;
assign state_bits[609]=spin;
assign dirty_bits[609]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[609];invalid<=0;end
 end
end
end
if(1) begin:state_0_610
reg spin,invalid;
assign state_bits[610]=spin;
assign dirty_bits[610]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[610];invalid<=0;end
 end
end
end
if(1) begin:state_0_611
reg spin,invalid;
assign state_bits[611]=spin;
assign dirty_bits[611]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[611];invalid<=0;end
 end
end
end
if(1) begin:state_0_620
reg spin,invalid;
assign state_bits[620]=spin;
assign dirty_bits[620]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[620];invalid<=0;end
 end
end
end
if(1) begin:state_0_621
reg spin,invalid;
assign state_bits[621]=spin;
assign dirty_bits[621]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[621];invalid<=0;end
 end
end
end
if(1) begin:state_0_622
reg spin,invalid;
assign state_bits[622]=spin;
assign dirty_bits[622]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[622];invalid<=0;end
 end
end
end
if(1) begin:state_0_623
reg spin,invalid;
assign state_bits[623]=spin;
assign dirty_bits[623]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[623];invalid<=0;end
 end
end
end
if(1) begin:state_0_624
reg spin,invalid;
assign state_bits[624]=spin;
assign dirty_bits[624]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[624];invalid<=0;end
 end
end
end
if(1) begin:state_0_625
reg spin,invalid;
assign state_bits[625]=spin;
assign dirty_bits[625]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[625];invalid<=0;end
 end
end
end
if(1) begin:state_0_626
reg spin,invalid;
assign state_bits[626]=spin;
assign dirty_bits[626]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[626];invalid<=0;end
 end
end
end
if(1) begin:state_0_627
reg spin,invalid;
assign state_bits[627]=spin;
assign dirty_bits[627]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[627];invalid<=0;end
 end
end
end
if(1) begin:state_0_636
reg spin,invalid;
assign state_bits[636]=spin;
assign dirty_bits[636]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[636];invalid<=0;end
 end
end
end
if(1) begin:state_0_637
reg spin,invalid;
assign state_bits[637]=spin;
assign dirty_bits[637]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[637];invalid<=0;end
 end
end
end
if(1) begin:state_0_638
reg spin,invalid;
assign state_bits[638]=spin;
assign dirty_bits[638]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[638];invalid<=0;end
 end
end
end
if(1) begin:state_0_639
reg spin,invalid;
assign state_bits[639]=spin;
assign dirty_bits[639]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==19)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[639];invalid<=0;end
 end
end
end
if(1) begin:state_0_644
reg spin,invalid;
assign state_bits[644]=spin;
assign dirty_bits[644]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[644];invalid<=0;end
 end
end
end
if(1) begin:state_0_645
reg spin,invalid;
assign state_bits[645]=spin;
assign dirty_bits[645]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[645];invalid<=0;end
 end
end
end
if(1) begin:state_0_646
reg spin,invalid;
assign state_bits[646]=spin;
assign dirty_bits[646]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[646];invalid<=0;end
 end
end
end
if(1) begin:state_0_647
reg spin,invalid;
assign state_bits[647]=spin;
assign dirty_bits[647]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[647];invalid<=0;end
 end
end
end
if(1) begin:state_0_648
reg spin,invalid;
assign state_bits[648]=spin;
assign dirty_bits[648]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[648];invalid<=0;end
 end
end
end
if(1) begin:state_0_649
reg spin,invalid;
assign state_bits[649]=spin;
assign dirty_bits[649]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[649];invalid<=0;end
 end
end
end
if(1) begin:state_0_650
reg spin,invalid;
assign state_bits[650]=spin;
assign dirty_bits[650]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[650];invalid<=0;end
 end
end
end
if(1) begin:state_0_651
reg spin,invalid;
assign state_bits[651]=spin;
assign dirty_bits[651]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[651];invalid<=0;end
 end
end
end
if(1) begin:state_0_660
reg spin,invalid;
assign state_bits[660]=spin;
assign dirty_bits[660]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[660];invalid<=0;end
 end
end
end
if(1) begin:state_0_661
reg spin,invalid;
assign state_bits[661]=spin;
assign dirty_bits[661]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[661];invalid<=0;end
 end
end
end
if(1) begin:state_0_662
reg spin,invalid;
assign state_bits[662]=spin;
assign dirty_bits[662]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[662];invalid<=0;end
 end
end
end
if(1) begin:state_0_663
reg spin,invalid;
assign state_bits[663]=spin;
assign dirty_bits[663]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[663];invalid<=0;end
 end
end
end
if(1) begin:state_0_664
reg spin,invalid;
assign state_bits[664]=spin;
assign dirty_bits[664]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[664];invalid<=0;end
 end
end
end
if(1) begin:state_0_665
reg spin,invalid;
assign state_bits[665]=spin;
assign dirty_bits[665]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[665];invalid<=0;end
 end
end
end
if(1) begin:state_0_666
reg spin,invalid;
assign state_bits[666]=spin;
assign dirty_bits[666]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[666];invalid<=0;end
 end
end
end
if(1) begin:state_0_667
reg spin,invalid;
assign state_bits[667]=spin;
assign dirty_bits[667]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==20)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[667];invalid<=0;end
 end
end
end
if(1) begin:state_0_676
reg spin,invalid;
assign state_bits[676]=spin;
assign dirty_bits[676]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[676];invalid<=0;end
 end
end
end
if(1) begin:state_0_677
reg spin,invalid;
assign state_bits[677]=spin;
assign dirty_bits[677]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[677];invalid<=0;end
 end
end
end
if(1) begin:state_0_678
reg spin,invalid;
assign state_bits[678]=spin;
assign dirty_bits[678]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[678];invalid<=0;end
 end
end
end
if(1) begin:state_0_679
reg spin,invalid;
assign state_bits[679]=spin;
assign dirty_bits[679]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[679];invalid<=0;end
 end
end
end
if(1) begin:state_0_680
reg spin,invalid;
assign state_bits[680]=spin;
assign dirty_bits[680]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[680];invalid<=0;end
 end
end
end
if(1) begin:state_0_681
reg spin,invalid;
assign state_bits[681]=spin;
assign dirty_bits[681]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[681];invalid<=0;end
 end
end
end
if(1) begin:state_0_682
reg spin,invalid;
assign state_bits[682]=spin;
assign dirty_bits[682]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[682];invalid<=0;end
 end
end
end
if(1) begin:state_0_683
reg spin,invalid;
assign state_bits[683]=spin;
assign dirty_bits[683]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[683];invalid<=0;end
 end
end
end
if(1) begin:state_0_692
reg spin,invalid;
assign state_bits[692]=spin;
assign dirty_bits[692]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[20];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[692];invalid<=0;end
 end
end
end
if(1) begin:state_0_693
reg spin,invalid;
assign state_bits[693]=spin;
assign dirty_bits[693]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[21];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[693];invalid<=0;end
 end
end
end
if(1) begin:state_0_694
reg spin,invalid;
assign state_bits[694]=spin;
assign dirty_bits[694]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[22];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[694];invalid<=0;end
 end
end
end
if(1) begin:state_0_695
reg spin,invalid;
assign state_bits[695]=spin;
assign dirty_bits[695]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[23];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[695];invalid<=0;end
 end
end
end
if(1) begin:state_0_696
reg spin,invalid;
assign state_bits[696]=spin;
assign dirty_bits[696]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[24];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[696];invalid<=0;end
 end
end
end
if(1) begin:state_0_697
reg spin,invalid;
assign state_bits[697]=spin;
assign dirty_bits[697]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[25];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[697];invalid<=0;end
 end
end
end
if(1) begin:state_0_698
reg spin,invalid;
assign state_bits[698]=spin;
assign dirty_bits[698]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[26];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[698];invalid<=0;end
 end
end
end
if(1) begin:state_0_699
reg spin,invalid;
assign state_bits[699]=spin;
assign dirty_bits[699]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==21)spin<=data_in[27];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[699];invalid<=0;end
 end
end
end
if(1) begin:state_0_708
reg spin,invalid;
assign state_bits[708]=spin;
assign dirty_bits[708]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[4];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[708];invalid<=0;end
 end
end
end
if(1) begin:state_0_709
reg spin,invalid;
assign state_bits[709]=spin;
assign dirty_bits[709]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[5];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[709];invalid<=0;end
 end
end
end
if(1) begin:state_0_710
reg spin,invalid;
assign state_bits[710]=spin;
assign dirty_bits[710]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[6];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[710];invalid<=0;end
 end
end
end
if(1) begin:state_0_711
reg spin,invalid;
assign state_bits[711]=spin;
assign dirty_bits[711]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[7];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[711];invalid<=0;end
 end
end
end
if(1) begin:state_0_712
reg spin,invalid;
assign state_bits[712]=spin;
assign dirty_bits[712]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[8];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[712];invalid<=0;end
 end
end
end
if(1) begin:state_0_713
reg spin,invalid;
assign state_bits[713]=spin;
assign dirty_bits[713]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[9];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[713];invalid<=0;end
 end
end
end
if(1) begin:state_0_714
reg spin,invalid;
assign state_bits[714]=spin;
assign dirty_bits[714]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[10];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[714];invalid<=0;end
 end
end
end
if(1) begin:state_0_715
reg spin,invalid;
assign state_bits[715]=spin;
assign dirty_bits[715]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[11];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[715];invalid<=0;end
 end
end
end
if(1) begin:state_0_720
reg spin,invalid;
assign state_bits[720]=spin;
assign dirty_bits[720]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[720];invalid<=0;end
 end
end
end
if(1) begin:state_0_721
reg spin,invalid;
assign state_bits[721]=spin;
assign dirty_bits[721]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[721];invalid<=0;end
 end
end
end
if(1) begin:state_0_722
reg spin,invalid;
assign state_bits[722]=spin;
assign dirty_bits[722]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[722];invalid<=0;end
 end
end
end
if(1) begin:state_0_723
reg spin,invalid;
assign state_bits[723]=spin;
assign dirty_bits[723]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[723];invalid<=0;end
 end
end
end
if(1) begin:state_0_732
reg spin,invalid;
assign state_bits[732]=spin;
assign dirty_bits[732]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[732];invalid<=0;end
 end
end
end
if(1) begin:state_0_733
reg spin,invalid;
assign state_bits[733]=spin;
assign dirty_bits[733]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[733];invalid<=0;end
 end
end
end
if(1) begin:state_0_734
reg spin,invalid;
assign state_bits[734]=spin;
assign dirty_bits[734]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[734];invalid<=0;end
 end
end
end
if(1) begin:state_0_735
reg spin,invalid;
assign state_bits[735]=spin;
assign dirty_bits[735]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==22)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[735];invalid<=0;end
 end
end
end
if(1) begin:state_0_736
reg spin,invalid;
assign state_bits[736]=spin;
assign dirty_bits[736]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[736];invalid<=0;end
 end
end
end
if(1) begin:state_0_737
reg spin,invalid;
assign state_bits[737]=spin;
assign dirty_bits[737]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[737];invalid<=0;end
 end
end
end
if(1) begin:state_0_738
reg spin,invalid;
assign state_bits[738]=spin;
assign dirty_bits[738]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[738];invalid<=0;end
 end
end
end
if(1) begin:state_0_739
reg spin,invalid;
assign state_bits[739]=spin;
assign dirty_bits[739]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[739];invalid<=0;end
 end
end
end
if(1) begin:state_0_748
reg spin,invalid;
assign state_bits[748]=spin;
assign dirty_bits[748]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[748];invalid<=0;end
 end
end
end
if(1) begin:state_0_749
reg spin,invalid;
assign state_bits[749]=spin;
assign dirty_bits[749]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[749];invalid<=0;end
 end
end
end
if(1) begin:state_0_750
reg spin,invalid;
assign state_bits[750]=spin;
assign dirty_bits[750]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[750];invalid<=0;end
 end
end
end
if(1) begin:state_0_751
reg spin,invalid;
assign state_bits[751]=spin;
assign dirty_bits[751]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[751];invalid<=0;end
 end
end
end
if(1) begin:state_0_752
reg spin,invalid;
assign state_bits[752]=spin;
assign dirty_bits[752]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[752];invalid<=0;end
 end
end
end
if(1) begin:state_0_753
reg spin,invalid;
assign state_bits[753]=spin;
assign dirty_bits[753]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[753];invalid<=0;end
 end
end
end
if(1) begin:state_0_754
reg spin,invalid;
assign state_bits[754]=spin;
assign dirty_bits[754]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[754];invalid<=0;end
 end
end
end
if(1) begin:state_0_755
reg spin,invalid;
assign state_bits[755]=spin;
assign dirty_bits[755]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[755];invalid<=0;end
 end
end
end
if(1) begin:state_0_764
reg spin,invalid;
assign state_bits[764]=spin;
assign dirty_bits[764]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[764];invalid<=0;end
 end
end
end
if(1) begin:state_0_765
reg spin,invalid;
assign state_bits[765]=spin;
assign dirty_bits[765]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[765];invalid<=0;end
 end
end
end
if(1) begin:state_0_766
reg spin,invalid;
assign state_bits[766]=spin;
assign dirty_bits[766]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[766];invalid<=0;end
 end
end
end
if(1) begin:state_0_767
reg spin,invalid;
assign state_bits[767]=spin;
assign dirty_bits[767]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==23)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[767];invalid<=0;end
 end
end
end
if(1) begin:state_0_768
reg spin,invalid;
assign state_bits[768]=spin;
assign dirty_bits[768]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[0];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[768];invalid<=0;end
 end
end
end
if(1) begin:state_0_769
reg spin,invalid;
assign state_bits[769]=spin;
assign dirty_bits[769]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[1];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[769];invalid<=0;end
 end
end
end
if(1) begin:state_0_770
reg spin,invalid;
assign state_bits[770]=spin;
assign dirty_bits[770]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[2];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[770];invalid<=0;end
 end
end
end
if(1) begin:state_0_771
reg spin,invalid;
assign state_bits[771]=spin;
assign dirty_bits[771]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[3];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[771];invalid<=0;end
 end
end
end
if(1) begin:state_0_780
reg spin,invalid;
assign state_bits[780]=spin;
assign dirty_bits[780]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[12];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[780];invalid<=0;end
 end
end
end
if(1) begin:state_0_781
reg spin,invalid;
assign state_bits[781]=spin;
assign dirty_bits[781]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[13];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[781];invalid<=0;end
 end
end
end
if(1) begin:state_0_782
reg spin,invalid;
assign state_bits[782]=spin;
assign dirty_bits[782]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[14];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[782];invalid<=0;end
 end
end
end
if(1) begin:state_0_783
reg spin,invalid;
assign state_bits[783]=spin;
assign dirty_bits[783]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[15];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[783];invalid<=0;end
 end
end
end
if(1) begin:state_0_784
reg spin,invalid;
assign state_bits[784]=spin;
assign dirty_bits[784]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[16];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[784];invalid<=0;end
 end
end
end
if(1) begin:state_0_785
reg spin,invalid;
assign state_bits[785]=spin;
assign dirty_bits[785]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[17];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[785];invalid<=0;end
 end
end
end
if(1) begin:state_0_786
reg spin,invalid;
assign state_bits[786]=spin;
assign dirty_bits[786]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[18];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[786];invalid<=0;end
 end
end
end
if(1) begin:state_0_787
reg spin,invalid;
assign state_bits[787]=spin;
assign dirty_bits[787]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[19];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[787];invalid<=0;end
 end
end
end
if(1) begin:state_0_796
reg spin,invalid;
assign state_bits[796]=spin;
assign dirty_bits[796]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[28];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[796];invalid<=0;end
 end
end
end
if(1) begin:state_0_797
reg spin,invalid;
assign state_bits[797]=spin;
assign dirty_bits[797]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[29];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[797];invalid<=0;end
 end
end
end
if(1) begin:state_0_798
reg spin,invalid;
assign state_bits[798]=spin;
assign dirty_bits[798]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[30];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[798];invalid<=0;end
 end
end
end
if(1) begin:state_0_799
reg spin,invalid;
assign state_bits[799]=spin;
assign dirty_bits[799]=invalid;
always @(posedge spin_clk_0_1) begin
 if(rst)begin spin<=0;invalid<=1;end
 else begin
  if(init_we&&phase==IDLE&&init_word==24)spin<=data_in[31];
  if(start_accept&&phase==IDLE)invalid<=1;
  if(local_commit&&replica==0&&color==1)begin spin<=update_bits[799];invalid<=0;end
 end
end
end
