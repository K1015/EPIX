...
`define EPIX_MODE 1
`endif
// 800-bit colored Gibbs solver: search control, decisions, and scores.
...
wire [799:0] current=state_bits,dirty_current=dirty_bits;
...
wire [799:0] state_bits,dirty_bits;
