# kings_maxcut128_instance1: IID baseline
...
```bash
./run.sh simulate --cases kings_maxcut128_instance1 --mode baseline
```
...
Use `-f cases/kings_maxcut128_instance1/baseline/files.f` from the package root. Build one case and mode at a time.
