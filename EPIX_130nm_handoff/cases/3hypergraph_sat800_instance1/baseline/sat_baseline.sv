module sat_baseline_solver #(
    parameter integer N=800, M=3440, FAMILY_XOR=0,
    parameter integer NODE_W=10, MEM_WORDS=14560,
    parameter integer MEM_AW=14, MEM_W=40, WEIGHT_W=1,
    parameter integer FIELD_W=8, TOTAL_WEIGHT=3440, FIELD_BOUND=27,
