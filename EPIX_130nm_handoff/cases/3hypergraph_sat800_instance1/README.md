# 3hypergraph_sat800_instance1

3-SAT with 800 variables; 3,440 factors; target 0 weighted violations.

Run both modes from the [package root](../../README.md):

```bash
./run.sh simulate --cases 3hypergraph_sat800_instance1
```
...
| [coefficients.hex](coefficients.hex) | 14,560 packed 40-bit words for factors and adjacency. |
...
- 14,560 × 40-bit coefficient memory; 114 SRAM22 banks share one logical port.
