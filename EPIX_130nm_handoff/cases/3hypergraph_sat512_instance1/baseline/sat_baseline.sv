module sat_baseline_solver #(
    parameter integer N=512, M=2202, FAMILY_XOR=0,
    parameter integer NODE_W=9, MEM_WORDS=9320,
    parameter integer MEM_AW=14, MEM_W=32, WEIGHT_W=1,
    parameter integer FIELD_W=8, TOTAL_WEIGHT=2202, FIELD_BOUND=26,
