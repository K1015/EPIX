...
The `vivado/` folder contains the complete project, RTL, ROMs and rebuild scripts. The `problem.json` and `config.json` files describe the fixed input and deployment. This input corresponds to `chimera/n26/instance01` in the 100-instance collection.
